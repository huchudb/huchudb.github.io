...
async function onCalculate(){
  ...
  const kpis = `
    <div class="kpis">
      <div class="kpi"><div class="kpi-label">요청 금액(총 실행)</div><div class="kpi-value">${formatKoreanCurrency(requestedLoan)}</div></div>
      <div class="kpi"><div class="kpi-label">추가 가능 금액</div><div class="kpi-value">${formatKoreanCurrency(addAvail)}</div></div>
    </div>`;
