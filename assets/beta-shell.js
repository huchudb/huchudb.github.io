...
(function(){
  ...
  var FOOTER_NOTICE_LINES = [
    '후추는 대중에게 온라인투자연계금융업(P2P)을 알려 채무자와 온투업체 모두에게 도움을 드리고자 설립되었습니다.',
    '후추는 온투업의 단순 정보 제공만 하는 회사로서, 온투업체의 대출 판매·대리·중개·모집 및 심사·승인·계약체결 등 대출에 관하여 일체 관여할수도, 하지도 않습니다.',
    '후추에서 안내되는 금리 등의 정보는 각 온투업체의 홈페이지 및 투자자 모집시 고지되는 내용을 바탕으로 한 과거 시점의 정보로 정확한 조건은 해당 온투업체에 직접 문의하세요.',
