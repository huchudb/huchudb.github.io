...
(function(){
  ...
  var FOOTER_NOTICE_LINES = [
    '후추는 온라인투자연계금융업(P2P) 대출 시장에 건전한 구조를 만들기 위해 단순 정보제공을 목적으로 합니다.',
    '후추는 온투업 대출의 판매·대리·중개·모집 및 심사·승인·계약체결 등 대출에 관하여 일체 관여할수도, 하지도 않습니다.',
    '후추에서 제공되는 금리 등의 정보는 각 온투업체의 홈페이지 및 투자자 모집시 고지되는 내용을 바탕으로 한 과거 시점의 정보입니다.',
