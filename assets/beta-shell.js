...
(function(){
  ...
  var FOOTER_NOTICE_LINES = [
    '후추는 온라인투자연계금융업(P2P)의 대중화를 통해 채무자와 온투업체 모두에게 도움이 되고자 설립되었습니다.',
    '후추는 온투업 관련 정보 제공만을 목적으로 하며, 온투업체의 대출 판매·대리·중개·모집 또는 심사·승인·계약 체결 등 대출과 관련된 어떠한 업무에도 관여하지 않습니다.',
    '후추에서 안내하는 금리 등 정보는 각 온투업체의 홈페이지 및 투자자 모집 시 고지된 내용을 바탕으로 한 과거 시점의 정보입니다. 정확한 조건은 해당 온투업체에 직접 문의해 주세요.',
    '온투업은 중·고금리이므로 단기간 사용해야하며, 대출시 상환계획도 함께 준비하세요.',
    '온투업 대출은 소개인을 통하지 않고, 직접 문의하시면 더욱 저렴한 조건으로 대출이 가능합니다.',
    '소개인을 통해 조건을 받았다면, 다른 온투업체에 직접 문의해보세요. 더 좋은 조건으로의 가능성이 높습니다.',
  ];
